...
export function IconTrain({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconList({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconEnquiries({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconAnalytics({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSetup({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBoard({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRuns({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSignOut({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconHelp({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconBell({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
export function IconPhone({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
...
export function IconNote({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconAlert({ size = 16, className = '', ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
